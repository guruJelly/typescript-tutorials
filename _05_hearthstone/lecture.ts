...
// node_modules 안에 파일 생성됨.

// 남의 패키지 중 가장 좋은 것.
// 1. TypeScript로 쓰여진 코드.
// 2. JavaScript로 쓰여졌지만, index.d.ts를 제공.
// 3. TypeScirpt가 전혀 없지만, DefinitelyTyped에서 제공.
// 4. TypeScript도 DefinitelyTyped에도 없는 경우. (내가 쓸 것만 생성)
